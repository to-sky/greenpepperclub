...
namespace woocommerceProducts\woocommerceProducts;
...
class Elements extends Container implements Module
{
    ...
    {
        /** @see \woocommerceProducts\woocommerceProducts\Elements::renderEditor */
        $this->addFilter(
    ...
    {
        if (strpos($response['shortcodeContent'], '[products ') !== false && !class_exists('WooCommerce')) {
