...
namespace woocommerceCart\woocommerceCart;
...
class Elements extends Container implements Module
{
    ...
    {
        /** @see \woocommerceCart\woocommerceCart\Elements::renderEditor */
        $this->addFilter(
    ...
    {
        if (strpos($response['shortcodeContent'], '[woocommerce_cart') !== false && !class_exists('WooCommerce')) {
