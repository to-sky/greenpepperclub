...
class Elements extends Container implements Module
{
    ...
    {
        /** @see \woocommerceProductCategories\woocommerceProductCategories\Elements::renderEditor */
        $this->addFilter(
    ...
    {
        if (strpos($response['shortcodeContent'], '[product_categories ') !== false && !class_exists('WooCommerce')) {
