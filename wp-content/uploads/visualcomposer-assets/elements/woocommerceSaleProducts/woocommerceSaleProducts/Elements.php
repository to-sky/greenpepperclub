...
namespace woocommerceSaleProducts\woocommerceSaleProducts;
...
class Elements extends Container implements Module
{
    ...
    {
        /** @see \woocommerceSaleProducts\woocommerceSaleProducts\Elements::renderEditor */
        $this->addFilter(
    ...
    {
        if (strpos($response['shortcodeContent'], '[sale_products ') !== false && !class_exists('WooCommerce')) {
