...
namespace woocommerceBestSellingProducts\woocommerceBestSellingProducts;
...
class Elements extends Container implements Module
{
    ...
    {
        /** @see \woocommerceBestSellingProducts\woocommerceBestSellingProducts\Elements::renderEditor */
        $this->addFilter(
    ...
    {
        if (strpos($response['shortcodeContent'], '[best_selling_products ') !== false && !class_exists('WooCommerce')) {
