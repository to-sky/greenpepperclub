...
+function ($) {
  ...
  TtaAutoPlay.prototype.show = function () {
    this.$element.find('[data-vce-classic-accordion]:eq(0)').vceClassicAccordion('showNext', { changeHash: false, scrollTo: false });
  };
  ...
  TtaAutoPlay.prototype.hasTimer = function () {
    return undefined !== this.$element.data('vce.classic.tta.autoplay.timer');
  };
  ...
  TtaAutoPlay.prototype.setTimer = function (windowInterval) {
    this.$element.data('vce.classic.tta.autoplay.timer', windowInterval);
  };
  ...
  TtaAutoPlay.prototype.getTimer = function () {
    return this.$element.data('vce.classic.tta.autoplay.timer');
  };
  ...
  TtaAutoPlay.prototype.deleteTimer = function () {
    this.$element.removeData('vce.classic.tta.autoplay.timer');
  };
  ...
  TtaAutoPlay.prototype.start = function () {
    ...
    if (!this.hasTimer()) {
      ...
      this.options.stopOnClick && $this.on('click.vce.classic.tta.autoplay.data-api',
        '[data-vce-classic-accordion]',
        stopHandler);
  ...
  TtaAutoPlay.prototype.stop = function () {
    ...
    this.$element.off('click.vce.classic.tta.autoplay.data-api mouseenter mouseleave');
  };
  ...
  old = $.fn.vceClassicTtaAutoPlay;

  $.fn.vceClassicTtaAutoPlay = Plugin;

  $.fn.vceClassicTtaAutoPlay.Constructor = TtaAutoPlay;

  /**
   * vceClassicTtaAutoPlay no conflict
   * @returns {$.fn.vceClassicTtaAutoPlay}
   */
  $.fn.vceClassicTtaAutoPlay.noConflict = function () {
    $.fn.vceClassicTtaAutoPlay = old;
    return this;
  };
