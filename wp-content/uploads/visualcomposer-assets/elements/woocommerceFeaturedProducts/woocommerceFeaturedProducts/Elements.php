...
namespace woocommerceFeaturedProducts\woocommerceFeaturedProducts;
...
class Elements extends Container implements Module
{
    ...
    {
        /** @see \woocommerceFeaturedProducts\woocommerceFeaturedProducts\Elements::renderEditor */
        $this->addFilter(
    ...
    {
        if (strpos($response['shortcodeContent'], '[featured_products ') !== false && !class_exists('WooCommerce')) {
