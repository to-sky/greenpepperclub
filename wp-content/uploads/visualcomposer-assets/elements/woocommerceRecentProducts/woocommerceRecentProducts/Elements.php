...
namespace woocommerceRecentProducts\woocommerceRecentProducts;
...
class Elements extends Container implements Module
{
    ...
    {
        /** @see \woocommerceRecentProducts\woocommerceRecentProducts\Elements::renderEditor */
        $this->addFilter(
    ...
    {
        if (strpos($response['shortcodeContent'], '[recent_products ') !== false && !class_exists('WooCommerce')) {
