...
namespace verticalSandwichMenu\verticalSandwichMenu;
...
class WpMenuShortcode extends Container implements Module
{
    ...
    {
        if (!defined('VCV_WP_VERTICAL_SANDWICH_MENU_SHORTCODE')) {
            $this->addEvent('vcv:inited', 'registerShortcode');
            define('VCV_WP_VERTICAL_SANDWICH_MENU_SHORTCODE', true);
        }
    }
    ...
    {
        $this->addShortcode('vcv_vertical_sandwich_menu', 'render');
    }
