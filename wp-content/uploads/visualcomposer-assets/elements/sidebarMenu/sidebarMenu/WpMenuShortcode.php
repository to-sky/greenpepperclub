...
namespace sidebarMenu\sidebarMenu;
...
class WpMenuShortcode extends Container implements Module
{
    ...
    {
        if (!defined('VCV_WP_SIDEBAR_MENU_SHORTCODE')) {
            $this->addEvent('vcv:inited', 'registerShortcode');
            define('VCV_WP_SIDEBAR_MENU_SHORTCODE', true);
        }
    }
    ...
    {
        $this->addShortcode('vcv_sidebar_menu', 'render');
    }
