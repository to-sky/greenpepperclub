...
class TemplateController extends Container implements Module
{
    ...
    protected function getGroupName($name, $payload)
    {
        switch ($payload['key']) {
            case 'hubHeader':
                $name = __('Header Templates', 'visualcomposer');
                break;
            case 'hubFooter':
                $name = __('Footer Templates', 'visualcomposer');
                break;
            case 'hubSidebar':
                $name = __('Sidebar Templates', 'visualcomposer');
                break;
            case 'block':
                $name = __('Block Templates', 'visualcomposer');
                break;
        }
