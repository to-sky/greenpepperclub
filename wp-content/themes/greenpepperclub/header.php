    ...
    <header id="masthead" class="site-header navbar-static-top <?php echo wp_bootstrap_starter_bg_class(); ?>"
        ...
        <div class="container">
            <nav class="navbar navbar-expand-xl p-0">
                ...
                <a class="text-white food-font18 cart-menu" href="https://www.greenpepperclub.ca/cart/"><i
                ...
                <a class="text-white food-font18 account" href="https://www.greenpepperclub.ca/my-account/" style=""><i
                            class="fa fa-user" style=""></i> <span style="">|</span></a>
                <a class="text-white food-font18 search-list" href="https://www.greenpepperclub.ca/cart/"><i
                            class="fa fa-shopping-cart"></i></a>
